...
public class ValidacionesSteps {
    ...
    public void validarProducto(){
        ...
        try{
            ...
            WebElement productoElement = wait.until(ExpectedConditions.visibilityOfElementLocated(BusquedaPageObject.getTxtProducto()));

            String textoElement = productoElement.getText();

            Assert.assertEquals(datosExcel.get(0).get("Producto"), textoElement);
